...
import { addJob, getJobs, getJob, updateJob, deleteJob, getJobsByStatusFilter, searchJobApplications } from "../controllers/job.controller.js";
...
router.get("/search", protect, searchJobApplications);
